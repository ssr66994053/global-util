...
/*
 * 修订记录:
 * linlin@yiji.com 2017-04-26 17:21 创建
 *
 */
 ...
 */
@Document(name = "基础的可分页订单",desc = "基础的可分页订单，定义了分页参数")
public class AbstractPageableOrder extends AbstractOrder implements Pagable  {
    //分页信息
    /**
     * 当前页
     */
